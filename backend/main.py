...
PRODUCT_RE    = re.compile(r'\b(product|item|collection|tshirt|t-shirt|shirt|pant|hoodie|jacket|bag|cap|hat|shoe|shorts|tank|compression|jogger|sweatshirt)\b', re.I)
